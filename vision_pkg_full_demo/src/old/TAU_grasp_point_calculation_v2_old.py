import math
from vision_pkg_full_demo.src.grasp_point_derivative_analysis_old import GraspPointDerivative
...
class GraspPointCalculation():
    ...
    def exec(self, all_cables_poly, all_cables_input, index_upper, dist_per_pixel, img, analyzed_grasp_length, plot_name=""):
        """
        ...
        """
        y_tot = y_max - y_min
        best_point, best_angle = self.gpd.exec(lower_cable_separation_poly, upper_cable_separation_poly, [min_x_eval, max_x_eval], [y_min, y_max], plot_name = plot_name)
