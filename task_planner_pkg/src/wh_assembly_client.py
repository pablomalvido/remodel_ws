...
rospy.init_node('WH_assembly_client_node')
...
client=actionlib.SimpleActionClient('/WHAssembly_as', process_UIAction) #Stablishes the connection with the server
